...
/**
 * External functions and service definitions for the unisbg payment gateway plugin.
 *
...
$functions = [
    'paygw_unisbg_get_config_for_js' => [
        'classname'   => 'paygw_unisbg\external\get_config_for_js',
        'classpath'   => '',
