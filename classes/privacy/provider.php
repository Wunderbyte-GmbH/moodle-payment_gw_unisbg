...
/**
 * Privacy Subsystem implementation for paygw_unisbg.
 *
...
namespace paygw_unisbg\privacy;
...
class provider implements \core_privacy\local\metadata\null_provider, paygw_provider {
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_unisbg');
        $record = $DB->get_record('paygw_unisbg', ['paymentid' => $payment->id]);

        $data = (object) [
            'orderid' => $record->unisbg_orderid,
        ];
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        ...
        $DB->delete_records_select('paygw_unisbg', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
